...
The R-squared is 0.4398, meaning the model explains about 44% of the variance in the log-transformed prevalence, which is ever higher than previous two predictors model. The adjusted R-squared is 0.4388, similar to the R-squared, indicating that the model generalizes well with the predictors.
