...
From the scatterplot shown above, we can see that the trend line is almost horizontal no matter what races are, which represents that temperature might not have significant association with asthma prevalence. 
